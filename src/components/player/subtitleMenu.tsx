...
export const SubtitleMenu = ({ tracks, player, configuredLanguage }: Props) => {
  ...
  const [selectedLanguage, setSelectedLanguage] = React.useState(configuredLanguage === undefined ? "" : configuredLanguage);  
  ...
  const [openingStateSelectedLanguage, setOpeningStateSelectedLanguage] = React.useState(configuredLanguage === undefined ? "" : configuredLanguage);
