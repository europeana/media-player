...
export const SubtitleMenu = ({ tracks, player, configuredLanguage }: Props) => {
  ...
  const autoGeneratedConfiguredLanguage = configuredLanguage === undefined ? false : new RegExp("(auto-generated)").test(refs[configuredLanguage].current?.innerText as string);
